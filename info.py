...
projects_data = {
    ...
    "Web Development Lab 03: Created an app that highlights my portfolio, finds suitable Disney characters from movies based on inputs, and takes as input a Disney Show"
}
